...
<div class="mb-3" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a class="text-decoration-none" href="{{ route('inventories.index') }}">Inventarios</a>
        </li>
        <li class="breadcrumb-item">
...
<div class="row">
    ...
    <div class="col-6">
        <form id="customerForm" action="{{ route('inventory-items.store') }}" method="POST">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" class="form-control" placeholder="Nombre" id="code" name="code"
                            value="{{ old('code') }}">
            ...
            <div class="row mt-2 g-3">
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="number" class="form-control" placeholder="Nombre" id="price" name="price" min="0"
                            value="{{ old('price') }}">
                ...
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" class="form-control" placeholder="Nombre" id="qty" name="qty" min="0"
                            value="{{ old('qty') }}">
